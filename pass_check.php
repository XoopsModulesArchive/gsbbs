...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
    <tr>
        <td align="center" valign="middle">
            <?php
            if ('bad' == isset($_GET['passcheck'])) {
                ?>
            <font color="#FF0000" size="+2">パスワードが正しくありません！</font>
            <p>
                <?php
            }
                ?>
            ...
            <table class="sread_table" border="0" cellspacing="0" cellpadding="6" bgcolor="#f0f0f0">
                <form action="data_modify.php" method="post">
                    <?php
                    if ('' != $caution_str) {
                        ?>
                        <tr>
                    ...
                    <tr>
                        <td nowrap>
                            PASS <input class="forminput" type="text" name="POST_PASS" value="<?= $_COOKIE['gsbbs_pass'] ?>" size="12" maxlength="10" border="0">
